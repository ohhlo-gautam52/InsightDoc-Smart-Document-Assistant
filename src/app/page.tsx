    ...
    <div className="flex flex-col min-h-screen ">
      <header className="px-4 lg:px-6 h-14 flex  items-center border-b sticky top-0 bg-background z-50">
        <Link className="flex items-center justify-center" href="#">
          ...
          <span className="ml-2 text-xl font-bold">InsightDoc</span>
        </Link>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Simply upload your PDF document to our secure InsightDoc
                  platform.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 mb-4">
                    "InsightDoc has revolutionized the way I interact with
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              ...
              <div className="w-full max-w-sm space-y-2">
                ...
                <p className="text-xs text-white/60">
                  Try InsightDoc free for 14 days. No credit card required.
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t border-blue-200">
        <p className="text-xs text-gray-500 dark:text-gray-400">
          © 2024 InsightDoc. All rights reserved.
        </p>
